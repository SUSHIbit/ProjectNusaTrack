    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form method="POST" action="{{ route('admin.locations.store') }}">
            ...
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-500 mt-1">Enter the name of the state or location in Malaysia.</p>
            </div>
            
            <div class="mb-4">
                <div class="flex items-center">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Create Location</button>
            </div>
        </form>
    </div>
</div>
