...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="image" class="block text-gray-700 font-medium mb-2">Service Image (Optional)</label>
                ...
                <p class="text-sm text-gray-500 mt-1">Upload an image for this service (max 2MB).</p>
            </div>
