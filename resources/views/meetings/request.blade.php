            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form method="POST" action="{{ route('meetings.request.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="proposed_date" id="proposed_date" value="{{ old('proposed_date') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required min="{{ date('Y-m-d') }}">
                    </div>

                    <div class="mb-4">
                        <label for="proposed_time" class="block text-gray-700 font-medium mb-2">Proposed Time</label>
                        <input type="time" name="proposed_time" id="proposed_time" value="{{ old('proposed_time') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required>
                    </div>
                    ...
                    <div class="mt-6 flex justify-end">
                        <a href="{{ route('home') }}" class="px-4 py-2 border border-gray-300 rounded text-gray-700 mr-2 hover:bg-gray-50">Cancel</a>
